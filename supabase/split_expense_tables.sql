...
create index if not exists idx_split_payment_proofs_group_id on public.split_settlement_payment_proofs(group_id);
create index if not exists idx_split_payment_proofs_settlement_id on public.split_settlement_payment_proofs(settlement_id);
...
create index if not exists idx_split_reminders_group_id on public.split_reminders(group_id);
