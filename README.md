...
| PDF Tools | Merge, split, rotate, delete pages, reorder pages, extract pages, compress, unlock, protect, watermark, and clean metadata of PDFs |
...
- **Dedicated PDF tools** include merge, split, rotate, delete, reorder, extract, compress, unlock, protect, watermark, and clean metadata.
