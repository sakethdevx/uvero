...
| PDF Tools | Merge, split, rotate, delete pages, reorder pages, extract pages, compress, unlock, protect, and watermark PDFs |
...
- **Dedicated PDF tools** include merge, split, rotate, delete, reorder, extract, compress, unlock, protect, and watermark.
