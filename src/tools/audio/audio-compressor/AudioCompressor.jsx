            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="p-8">
                                ...
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                                        {[64, 128, 192, 256, 320].map((rate) => (
                                            ...
                                            >
                                                <div className="font-semibold text-gray-900 mb-1">{rate}</div>
                        ...
                        {result && (
                            <div className="space-y-6">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-gray-700 mb-4">
                                                Your audio has been compressed by <span className="font-bold text-green-700">{result.savings}%</span>
                                            </p>
                                ...
                                {/* Audio Preview */}
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    <h3 className="text-sm font-semibold text-gray-700 mb-3">Preview Compressed Audio</h3>
                                    <audio
                                        controls
                                        className="w-full"
                                        src={result.url}
                ...
                <div className="mt-12 grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">Flexible Bitrates</h3>
                        <p className="text-gray-600 text-sm">
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Which bitrate should I choose?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">What formats are supported?</h3>
                            <p className="text-gray-600 text-sm">
                                Input: MP3, WAV, OGG files up to 50MB. Output: MP3 format with your chosen bitrate.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Is my audio secure?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Will compression affect audio quality?</h3>
                            <p className="text-gray-600 text-sm">
