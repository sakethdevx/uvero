            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white rounded-xl shadow-md p-6">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">MP4 Support</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">High Quality MP3</h3>
                        <p className="text-gray-600 text-sm">
                ...
                <div className="bg-white rounded-xl shadow-md p-8">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">About MP4 to MP3 Conversion</h2>
