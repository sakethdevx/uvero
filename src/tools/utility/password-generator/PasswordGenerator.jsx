                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            <input
                                ...
                                value={password}
                                readOnly
                                className="w-full px-4 py-4 pr-24 text-lg font-mono bg-gray-50 border-2 border-gray-200 rounded-lg focus:outline-none"
                            />
                            <Button
                                onClick={handleCopy}
                                disabled={!password}
                    ...
                    <div className="mb-6">
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center gap-3 p-3 rounded-lg border-2 border-gray-200 hover:border-cyan-300 cursor-pointer transition-colors">
                                <input
                                    type="checkbox"
                                ...
                                <div className="flex-1">
                                    <div className="font-medium text-gray-900">Uppercase Letters (A-Z)</div>
                                    <div className="text-xs text-gray-500 font-mono">ABCDEFGHIJKLMNOPQRSTUVWXYZ</div>
                                </div>
                            </label>
                            ...
                            <label className="flex items-center gap-3 p-3 rounded-lg border-2 border-gray-200 hover:border-cyan-300 cursor-pointer transition-colors">
                                ...
                                />
                                <div className="flex-1">
                                    <div className="font-medium text-gray-900">Lowercase Letters (a-z)</div>
                                    <div className="text-xs text-gray-500 font-mono">abcdefghijklmnopqrstuvwxyz</div>
                                </div>
                            </label>
                            ...
                            <label className="flex items-center gap-3 p-3 rounded-lg border-2 border-gray-200 hover:border-cyan-300 cursor-pointer transition-colors">
                                ...
                                />
                                <div className="flex-1">
                                    <div className="font-medium text-gray-900">Numbers (0-9)</div>
                                    <div className="text-xs text-gray-500 font-mono">0123456789</div>
                                </div>
                            </label>
                            ...
                            <label className="flex items-center gap-3 p-3 rounded-lg border-2 border-gray-200 hover:border-cyan-300 cursor-pointer transition-colors">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-gray-500 font-mono">!@#$%^&*()_+-=[]|;:,.</div>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center gap-3 p-3 rounded-lg border-2 border-gray-200 hover:border-cyan-300 cursor-pointer transition-colors">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-gray-500">Avoid confusion: i, l, 1, L, o, 0, O</div>
                                </div>
                            </label>
                            ...
                            <label className="flex items-center gap-3 p-3 rounded-lg border-2 border-gray-200 hover:border-cyan-300 cursor-pointer transition-colors">
                                ...
                                />
                                <div className="flex-1">
                                    <div className="font-medium text-gray-900">Exclude Ambiguous Symbols</div>
                                    <div className="text-xs text-gray-500">Avoid special chars: {`{} [] () / \\ ' " \` ~ , ; : . < >`}</div>
                                </div>
                            </label>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-1">Use at least 12-16 characters</h3>
                                <p className="text-gray-600 text-sm">Longer passwords are exponentially harder to crack.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-1">Mix different character types</h3>
                                <p className="text-gray-600 text-sm">Combine uppercase, lowercase, numbers, and symbols for maximum security.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-1">Use unique passwords for each account</h3>
                                <p className="text-gray-600 text-sm">Never reuse passwords across different websites or services.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-1">Use a password manager</h3>
                                <p className="text-gray-600 text-sm">Store your passwords securely in a reputable password manager.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm">Add an extra layer of security whenever possible.</p>
                            </div>
                        </div>
                    </div>
