            ...
            <div className="max-w-4xl mx-auto">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    >
                                        ...
                                        <div className="font-semibold text-gray-900">Multiple Images</div>
                                    ...
                                    >
                                        ...
                                        <div className="font-semibold text-gray-900">Video File</div>
                                        <div className="text-xs text-gray-500 mt-1">
                                            Convert to GIF
                                        </div>
                                    </button>
                                    ...
                                    <div className="space-y-6 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                ...
                                                >
                                                    <div className="font-semibold text-gray-900">Infinite</div>
                                                </button>
                                                <button
                                                    onClick={() => setLoop(1)}
                                                ...
                                                >
                                                    <div className="font-semibold text-gray-900">Once</div>
                                                </button>
                                                <button
                                                    onClick={() => setLoop(3)}
                                                ...
                                                >
                                                    <div className="font-semibold text-gray-900">3 Times</div>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div className="space-y-4 text-gray-600">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Create GIFs From</h3>
