        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                        ...
                                        >
                                            <div className="font-semibold text-gray-900 mb-1">Low</div>
                                            <div className="text-sm text-gray-600">Minimal optimization</div>
                                            <div className="text-xs text-gray-500 mt-1">Basic cleanup only</div>
                                        </button>
                                        <button
                                        ...
                                        >
                                            ...
                                            <div className="text-xs text-gray-500 mt-1">Structure optimization</div>
                                        </button>
                                        <button
                                        ...
                                        >
                                            <div className="font-semibold text-gray-900 mb-1">High</div>
                                            <div className="text-sm text-gray-600">Maximum optimization</div>
                                            <div className="text-xs text-gray-500 mt-1">Removes all metadata</div>
                                        </button>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-gray-700 mb-4">
                                                Your PDF has been compressed by <span className="font-bold text-green-700">{result.savings}%</span>
                                            </p>
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                ...
                                                <div className="bg-white bg-opacity-60 rounded-lg p-3 border border-green-100">
                                                    <div className="text-gray-600 mb-1">Compressed Size</div>
                                                    <div className="font-semibold text-green-700">{formatFileSize(result.compressedSize)}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="font-semibold text-gray-900 mb-2">Choose Level</h3>
                            <p className="text-sm text-gray-600">Select compression level based on your needs</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Click compress and watch the magic happen</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Get your compressed PDF instantly</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How does PDF compression work?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Which compression level should I choose?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Can I compress password-protected PDFs?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How long does compression take?</h3>
                            <p className="text-gray-600 text-sm">
