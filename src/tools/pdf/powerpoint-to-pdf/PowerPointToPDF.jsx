            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white rounded-xl shadow-md p-6">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">Format Support</h3>
                ...
                <div className="bg-white rounded-xl shadow-md p-8">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How do I convert PowerPoint to PDF?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">What PowerPoint formats are supported?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Are there any limitations?</h3>
                            <p className="text-gray-600 text-sm">
