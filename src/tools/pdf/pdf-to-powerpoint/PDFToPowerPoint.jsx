            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
                    {!file ? (
                        <div
                            ...
                            className="border-3 border-dashed border-gray-300 rounded-xl p-12 text-center hover:border-orange-400 transition-colors cursor-pointer"
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white rounded-xl shadow-md p-6">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">Text to Slides</h3>
                ...
                <div className="bg-white rounded-xl shadow-md p-8">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How do I convert PDF to PowerPoint?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">What happens to my formatting?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Can I edit the PowerPoint after conversion?</h3>
                            <p className="text-gray-600 text-sm">
