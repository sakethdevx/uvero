        ...
        <div className="min-h-screen bg-gradient-to-br from-lime-50 via-white to-green-50">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                        <button
                                            ...
                                            className="p-3 rounded-lg border-2 border-gray-200 hover:border-gray-300 bg-white transition-all text-center text-sm font-medium text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            No Crop
                                        </button>
                                        <button
                                        ...
                                        {['top', 'right', 'bottom', 'left'].map((side) => (
                                            <div key={side}>
                                                ...
                                                <input
                                                    ...
                                                    disabled={isProcessing}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 disabled:opacity-50"
                                                />
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {!allPages && (
                                            <div>
                                                <label className="block text-xs text-gray-500 mb-1">Page range (e.g., 1-3,5,7-9)</label>
                                                <input
                                                    type="text"
                                                    value={pageRange}
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="font-semibold text-gray-900 mb-2">Set Margins</h3>
                            <p className="text-sm text-gray-600">Choose a preset or set custom crop margins</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Click crop and the margins are applied instantly</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Get your cropped PDF instantly</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How does PDF cropping work?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">What are the crop presets?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">What are "points" in margin settings?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Can I crop specific pages only?</h3>
                            <p className="text-gray-600 text-sm">
