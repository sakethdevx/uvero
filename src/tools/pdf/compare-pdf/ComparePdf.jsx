            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        {!result && (
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <h3 className="text-sm font-semibold text-gray-700 mb-3">Original PDF</h3>
                                        {!file1 ? (
                                            <Dropzone
                                            ...
                                            <div className="border-2 border-amber-200 bg-amber-50 rounded-xl p-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-sm font-semibold text-gray-900 truncate">{file1.name}</p>
                                    ...
                                    <div>
                                        <h3 className="text-sm font-semibold text-gray-700 mb-3">Modified PDF</h3>
                                        {!file2 ? (
                                            <Dropzone
                                            ...
                                            <div className="border-2 border-yellow-200 bg-yellow-50 rounded-xl p-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-sm font-semibold text-gray-900 truncate">{file2.name}</p>
                            ...
                            <div className="space-y-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                <div className="bg-white bg-opacity-60 rounded-lg p-3 border border-gray-100">
                                                    <div className="text-gray-600 mb-1">Original PDF</div>
                                                    <div className="font-semibold text-gray-900">{result.file1Pages} page{result.file1Pages !== 1 ? 's' : ''}</div>
                                                </div>
                                                <div className="bg-white bg-opacity-60 rounded-lg p-3 border border-gray-100">
                                                    <div className="text-gray-600 mb-1">Modified PDF</div>
                                                    <div className="font-semibold text-gray-900">{result.file2Pages} page{result.file2Pages !== 1 ? 's' : ''}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {result.differences.length > 0 && (
                                    <div className="space-y-3">
                                        <h3 className="font-semibold text-gray-900">Page-by-Page Results</h3>
                ...
                <div className="mt-12 grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">Fast Comparison</h3>
                        <p className="text-gray-600 text-sm">
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        <div className="text-center">
                            ...
                            <h3 className="font-semibold text-gray-900 mb-2">Upload Original</h3>
                            <p className="text-sm text-gray-600">Drag & drop or click to select the original PDF</p>
                        </div>
                        <div className="text-center">
                            ...
                            <h3 className="font-semibold text-gray-900 mb-2">Upload Modified</h3>
                            <p className="text-sm text-gray-600">Add the modified version of the PDF</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Click compare and let the tool analyze both files</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">See detailed differences page by page</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How does PDF comparison work?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">What types of differences can it detect?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Are my PDFs secure?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Can it compare scanned PDFs?</h3>
                            <p className="text-gray-600 text-sm">
