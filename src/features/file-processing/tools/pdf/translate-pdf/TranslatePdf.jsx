            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-sm text-gray-600 mb-2">Source Language</label>
                                            <select
                                                value={sourceLang}
                                                onChange={(e) => setSourceLang(e.target.value)}
                                                disabled={isProcessing}
                                                className="w-full px-4 py-2.5 rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:ring-2 focus:ring-pink-500 focus:border-pink-500 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                                {LANGUAGES.map(lang => (
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <textarea
                                        ...
                                        rows={8}
                                        className="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 text-sm font-mono resize-y focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                                    />
                                </div>
                ...
                <div className="mt-12 grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                        ...
                        <h3 className="font-semibold text-gray-900 mb-2">15 Languages</h3>
                        <p className="text-gray-600 text-sm">
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="font-semibold text-gray-900 mb-2">Select Languages</h3>
                            <p className="text-sm text-gray-600">Choose your source and target languages</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Click translate and the text will be extracted and processed</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Get your translated PDF instantly</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How does PDF translation work?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Which languages are supported?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Will translation affect PDF layout?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Can I translate scanned PDFs?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How accurate is the translation?</h3>
                            <p className="text-gray-600 text-sm">
