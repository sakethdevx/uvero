        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                                        ...
                                        >
                                            <div className="font-semibold text-gray-900 mb-1">All Pages</div>
                                            <div className="text-sm text-gray-600">Rotate every page in the PDF</div>
                                        </button>
                                        <button
                                        ...
                                        >
                                            <div className="font-semibold text-gray-900 mb-1">Specific Pages</div>
                                            <div className="text-sm text-gray-600">Choose which pages to rotate</div>
                                        </button>
                                    </div>
                                    {pageMode === 'specific' && (
                                        <div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                ...
                                                <div className="bg-white bg-opacity-60 rounded-lg p-3 border border-green-100">
                                                    <div className="text-gray-600 mb-1">Rotated Size</div>
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Select rotation angle and pages to rotate</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Click rotate and watch the magic happen</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600">Get your rotated PDF instantly</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">How does PDF rotation work?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Which rotation angle should I choose?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Can I rotate only specific pages?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Will rotation affect PDF quality?</h3>
                            <p className="text-gray-600 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Can I rotate password-protected PDFs?</h3>
                            <p className="text-gray-600 text-sm">
