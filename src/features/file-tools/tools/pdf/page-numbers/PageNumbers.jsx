...
export default function PageNumbers() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 dark:from-gray-900 via-white to-violet-50">
            {/* Hero Section */}
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-12 bg-white dark:bg-gray-800 rounded-xl p-8 border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300">Choose position, format, size, and color</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300">Click the button and page numbers are added</p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300">Get your numbered PDF instantly</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-white dark:bg-gray-800 rounded-xl p-8 border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Where can I place page numbers?</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm">
                                You can place page numbers at the bottom center, bottom left, bottom right, top center, top left, or top right of each page.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">What formats are available?</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Can I customize the appearance?</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm">
