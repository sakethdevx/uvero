            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-12 grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
                        ...
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Delete Pages</h3>
                        <p className="text-gray-600 dark:text-gray-300 text-sm">
                ...
                <div className="mt-12 bg-white dark:bg-gray-800 rounded-xl p-8 border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Organize</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-300">Reorder or remove pages as needed</p>
                        </div>
                        <div className="text-center">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300">Get your reorganized PDF instantly</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-white dark:bg-gray-800 rounded-xl p-8 border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">How do I reorder pages?</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Can I delete pages from my PDF?</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Will the PDF quality be affected?</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm">
