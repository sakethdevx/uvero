    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                className={`flex items-center gap-3 px-4 py-2.5 rounded-xl border transition-all duration-300 group shadow-sm ${
                    isOpen 
            ...
            >
                <span className="text-xl group-hover:scale-110 transition-transform duration-300">{current?.icon || '💻'}</span>
                ...
                <svg className={`ml-1 w-4 h-4 text-gray-400 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
