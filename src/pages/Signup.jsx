            ...
            <div className="relative flex min-h-screen items-center justify-center px-4 py-16 sm:px-6">
                <div className="w-full max-w-md">
                    <div className="rounded-3xl border border-gray-200/80 bg-gradient-to-br from-primary-50 via-white to-blue-50 p-8 shadow-xl shadow-primary-100/40 dark:border-white/[0.08] dark:from-primary-500/10 dark:via-gray-950 dark:to-blue-500/10 dark:shadow-none">
                        ...
                        <h1 className="mt-3 text-3xl font-black tracking-tight text-gray-900 dark:text-white">Create account</h1>
                        <p className="mt-1.5 text-sm text-gray-500 dark:text-gray-400">Sign up for free and start using Uvero right away.</p>
                        ...
                        <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <Link to="/login" state={location.state} className="text-primary-600 dark:text-primary-400 font-medium hover:underline">Sign in</Link>
                        </div>
                    </div>
                </div>
            </div>
