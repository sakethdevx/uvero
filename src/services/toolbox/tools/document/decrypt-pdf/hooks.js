...
export const usePdfUnlock = () => {
    ...
    const initWorker = useCallback(() => {
        ...
        const worker = new Worker(new URL('../../document/shared/pdfSecurity/decrypt/worker.js', import.meta.url), {
            type: 'module'
        });
    ...
    const unlock = useCallback((files, options = {}) => {
        if (!workerRef.current) {
            initWorker();
        }
