                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs text-gray-600 dark:text-gray-400 font-medium">CST (Central Standard Time) is UTC-6</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="w-1.5 h-1.5 rounded-full bg-orange-500"></div>
                        ...
                        <div className="p-3 bg-white dark:bg-black/20 rounded-xl border border-orange-500/10 text-[10px] font-mono text-orange-600/80 dark:text-orange-400/80 leading-relaxed italic">
                            Note: This tool uses a fixed 1-hour offset. For DST-aware conversions, please utilize the primary Time Zone Converter engine.
                        </div>
                    </div>
                </div>
            </div>
