                ...
                <div className="relative p-3.5 sm:p-5">
                    <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="flex flex-wrap items-center justify-between sm:justify-end gap-3 md:gap-4 w-full sm:w-auto">
                            ...
                            <div className={`flex items-center gap-2 px-3 h-10 rounded-xl border transition-all duration-500 shrink-0 ${engineStatus === 'ready'
                                ...
                                <div className={`w-1.5 h-1.5 rounded-full shrink-0 ${engineStatus === 'ready' ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.5)]' :
                            ...
                            <div className="grid grid-cols-1 min-w-0 gap-4 sm:gap-6 lg:grid-cols-[minmax(320px,0.75fr)_minmax(0,1fr)]">
                                ...
                                <div className="min-w-0 space-y-4 lg:hidden xl:block">
                                    <div>
                                        ...
                                        <div className="max-h-[260px] overflow-y-auto sm:pr-2 sm:-mr-2 custom-scrollbar">
