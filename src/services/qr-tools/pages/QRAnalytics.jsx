    ...
    return (
        <AIServiceShell>
            ...
            <CompactServiceHeader
                ...
                description="Compact scan trends, country breakdown, and top code activity."
                actions={data && data.total_codes > 0 && (
                    <button onClick={() => exportCSV(data)} className="suggestion-chip !opacity-100 !animate-none">
